...
public class TotalBalanceException extends Exception {

    private List<ServiceErrorItem> errors;

    public TotalBalanceException(String message, List<ServiceErrorItem> errors) {
        super(message);
        this.errors = errors;
    }

    public TotalBalanceException(String message) {
        super(message);
    }
