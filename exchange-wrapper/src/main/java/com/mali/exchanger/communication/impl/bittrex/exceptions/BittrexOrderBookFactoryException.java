...
public class BittrexOrderBookFactoryException extends Exception {

    private List<ServiceErrorItem> errors;

    public BittrexOrderBookFactoryException(String msg) {
        super(msg);
    }

    public BittrexOrderBookFactoryException(String msg, List<ServiceErrorItem> errors) {
        super(msg);
        this.errors = errors;
    }
