...
public class BitfinexOrderBookFactoryException extends  Exception {

    private List<ServiceErrorItem> errors;

    public BitfinexOrderBookFactoryException(String message) {
        super(message);
    }

    public BitfinexOrderBookFactoryException(String message, List<ServiceErrorItem> errors) {
        super(message);
        this.errors = errors;
    }
