...
@Service
public class OkexBuyDealImpl implements Deal {
    ...
    public TradeResult newDeal(Exchanger exchanger,Market market, double quantity, double price, String key, String secret) throws DealException {
        try {
            com.mali.exchanger.communication.impl.okex.sub.entity.TradeResult okexTradeResult = apis.newBuyOrder(price, quantity, market, key, secret);
            ...
            e.printStackTrace();
            throw new DealException("Problema no new deal (okex new buy)");
        }
    }
