            ...
            <div style="padding:30px;">
                ...
                <div style="width:600px;margin:0 auto;background:#fff;border-radius:2px;border:1px solid #ddd;margin-top:30px;">
                    ...
                    <div style="padding:15px;text-align:center;">
                       <span>
                                <img src="https://s3-sa-east-1.amazonaws.com/static.crypfy/img/information.png"
                                     alt="information" width="140"/>
                            </span>
                        <h1 style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:22px;line-height: 25px;color:#333;margin-top:30px;">
                        ...
                        <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:14px;line-height: 30px;color:#6b6b6b;margin-top:30px;display:block;">
                                Sua identidade foi negada pela razão abaixo, faça o processo novamente!
                            </span>
