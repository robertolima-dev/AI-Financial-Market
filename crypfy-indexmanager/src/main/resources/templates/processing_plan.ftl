                ...
                <div style="width:600px;margin:0 auto;background:#fff;border-radius:2px;border:1px solid #ddd;margin-top:30px;">
                    <div style="padding:20px;border-bottom:1px solid #ddd;text-align: center;">
                        <h1 style="font-family: Trebuchet MS, Helvetica, sans-serif;font-weight:300;color:#444444;font-size:22px;">
                            Plano ${planName} ${planDuration} em Processamento
                        </h1>
                    </div>
                    <div style="padding:30px;text-align:center;">
                        <span>
                                <img src="${planImg}"
                                     alt="plan ${planName}" width="150"/>
                            </span>
                        <h3 style="font-family: Trebuchet MS, Helvetica, sans-serif;font-weight:300;color:#444444;font-size:22px;">
                            Plano ${planName} ${planDuration}
                        </h3>
                        <h3 style="font-family: Trebuchet MS, Helvetica, sans-serif;font-weight:300;color:#444444;font-size:16px;margin-top:20px;">
                        ${planCustomName}
                        </h3>
                        <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:14px;line-height: 24px;color:#6b6b6b;margin-top:50px;display:block;">
                                Parabéns pela Contratação de seu novo Plano! Seu plano <strong>${planName} ${planDuration}</strong> no valor de R$ <strong>${initialBalance}</strong> está em fase de Processamento. Em até dois dias úteis o mesmo estará vigente!
                            </span>
                    </div>
                </div>
