...
class PlanAddAudace extends React.Component {
    ...
    componentDidMount() {
        planActions.getPerfomance(2).then((ret) => {
            const labels = [];
            const data = [];
                ...
                datasets: [
                    {
                        ...
                        borderColor: '#197C72',
                        borderWidth: 2,
                        hoverBackgroundColor: '#197C72',
                        hoverBorderColor: '#197C72',
                        data: data
                    }
                ]
            };
    ...
    render() {
        if (this.state.render)
            return (
                <div>
                    <div className="row margin-top-50 animated fadeIn">
                        <div className="col-md-7">
                            <h1>
                                Plano Audace
                                <span className="float-right font-15 badge badge-audace">
                                    Moderado
                                </span>
                            </h1>
                            <p className="description margin-top-20">
                                Destinado à investidores de perfil moderado, o Plano Audace é indicado para quem procura o equilíbrio de perfomances entre curto e longo prazo, participando de forma moderada das movimentações do mercado.
                            </p>
                            ...
                            <div className="row margin-top-10">
                                <div className="col-md-6">
                                    <h5 className="font-15">Valor Mínimo Investimento: <strong>R$ 1.000,00</strong></h5>
                                </div>
                                <div className="col-md-6">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <h5 className="font-15">Taxa Perfomance 6 Meses: <strong>30%</strong></h5>
                                </div>
                                <div className="col-md-6">
                                    <h5 className="font-15">Taxa Perfomance 12 Meses: <strong>25%</strong></h5>
                                </div>
                            </div>
                            <div className="row margin-top-30">
                                <div className="col-md-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <SimpleInput value={this.state.inputFeeValue} disabled="true" ref="inputInputFee" className="form-control" label={"Taxa Entrada ("+this.state.inputFee+"%)"} />
                                </div>
                                <div className="col-md-4">
                                    <SimpleInput value={this.state.netAmount} disabled="true" ref="inputNetValue" className="form-control" label="Valor Final Investimento"/>
                                </div>
                            </div>
                            <div className="row">
                                <div style={{marginTop: "10px"}} className="col-md-12">
                                    <label className="label block">Duração</label>
                                    <RadioGroup name="radio" value={this.state.duration} onChange={(e, value) => {
                    ...
                    <Modal isOpen={this.state.confirmationModal}
                        ...
                        <ModalBody>
                            <div className="text-center animated fadeIn">
                                ...
                                <p className="margin-top-20">Seu plano <strong>Audace {this.state.duration}</strong> foi
...
export default connect(mapStateToProps, mapDispatchToProps)(PlanAddAudace);