...
class PlanAddLinea extends React.Component {
                ...
                datasets: [
                    {
                        ...
                        borderColor: '#973fbc',
                        borderWidth: 2,
                        hoverBackgroundColor: '#973fbc',
                        hoverBorderColor: '#973fbc',
                        data: data
                    }
                ]
            };
                ...
                <div>
                    <div className="row margin-top-50 animated fadeIn">
                        <div className="col-md-7 col-sm-12 col-12">
                            <h1>
                                Plano Línea
                                <span className="float-right font-15 badge badge-linea">
                                    Conservador
                                </span>
                            </h1>
                            <p className="description margin-top-20">
                                Destinado à investidores de perfil Conservador, o Plano Línea é indicado para quem procura
                                não participar dos extremos do mercado e deseja efetuar resgates frequentes dos seus
                                lucros gerados em um curto e médio espaço de tempo, participando de forma conservadora das movimentações do mercado.
                            </p>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <h5 className="font-15">Taxa Perfomance 6 Meses: <strong>25%</strong></h5>
                                </div>
                                <div className="col-md-6">
                                    <h5 className="font-15">Taxa Perfomance 12 Meses: <strong>20%</strong></h5>
                                </div>
                            </div>
                            <div className="row margin-top-30">
                                <div className="col-md-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <SimpleInput value={this.state.inputFeeValue} disabled="true" ref="inputInputFee"
                    ...
                    <Modal isOpen={this.state.confirmationModal}
                        ...
                        <ModalBody>
                            <div className="text-center">
                                ...
                                <p className="margin-top-20">Seu plano <strong>Línea {this.state.duration}</strong> foi
...
export default connect(mapStateToProps, mapDispatchToProps)(PlanAddLinea);