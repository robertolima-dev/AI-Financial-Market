                    ...
                    <div style="padding:30px;text-align:center;">
                       <span>
                        ...
                        <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:14px;line-height: 30px;color:#6b6b6b;margin-top:30px;display:block;">
                                Sua intenção de saque na data <strong>${date}</strong>, no valor de R$ <strong>${amount}</strong>, foi Negada pelo Motivo:
                            </span>

                        <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:700;font-size:14px;line-height: 30px;color:#6b6b6b;margin-top:30px;display:block;">
                        ${denied_reason}
                            </span>
