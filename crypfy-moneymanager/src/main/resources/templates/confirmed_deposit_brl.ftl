        ...
        <td align="center" valign="top">
            <div style="padding:30px;">
                ...
                <div style="width:600px;margin:0 auto;background:#fff;border-radius:2px;border:1px solid #ddd;margin-top:30px;">
                    <div style="padding:20px;border-bottom:1px solid #ddd;text-align: center;">
                        <h1 style="font-family: Trebuchet MS, Helvetica, sans-serif;font-weight:300;color:#444444;font-size:22px;">
                            Intenção de Depósito Confirmada
                        </h1>
                    </div>
                    <div style="padding:30px;text-align:center;">
                       <span>
                                <img src="https://s3-sa-east-1.amazonaws.com/static.crypfy/img/bitcoin-wallet.png"
                                     alt="bitcoin wallet" width="190"/>
                            </span>
                        <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:14px;line-height: 25px;color:#6b6b6b;margin-top:30px;display:block;">
                                Sua intenção de depósito na data <strong>${date}</strong>, no valor de R$ <strong>${amount}</strong>, foi confirmada! Você já pode contratar os planos Crypfy com seu saldo disponível em carteira!
                            </span>
                    </div>
                </div>
                <span style="font-family:Trebuchet MS, Helvetica, sans-serif;font-weight:300;font-size:14px;line-height: 30px;color:#6b6b6b;margin-top:30px;display:block;">
                                Caso tenha dúvidas de como contratar os planos, clique <a href="https://crypfy.zendesk.com/hc/pt-br/articles/360002346172-Contratar-Planos-Crypfy" target="_blank">aqui</a>.
                            </span>
            </div>
        </td>
    </tr>
