...
/**
 * Interface Witch Consumes a Brl Deposits Events from a Topic
 */
public interface DepositBrlNotificationConsumer {
    ...
    /**
     * Consumes a topic and send waiting photo upload email
     * @param depositWithdrawRequestBrl
     * @throws EmailException
     * @throws HtmlTemplateBuilderException
     */
